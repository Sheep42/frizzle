Feeding_CrankGame = {}
class( "Feeding_CrankGame" ).extends( Microgame )
local scene = Feeding_CrankGame
...
function scene:init()
	...
	foodAnim:addState( foodStates[1], 1, 1, nil, nil, nil, 0 )
	foodAnim:addState( foodStates[2], 2, 2, nil, nil, nil, 0 )
	foodAnim:addState( foodStates[3], 3, 3, nil, nil, nil, 0 )

	foodAnim:setState( foodStates[math.random(#foodStates)] )
